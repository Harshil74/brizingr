...
import com.example.brizingr2k19.expantable.ExpantableICNon;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class ICNon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_icnon);
        mTopToolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(mTopToolbar);
        getSupportActionBar().setTitle("IC Non-Techanical");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        expandableListView = findViewById(R.id.expandableListViewICNon);
        expandableListDetail = ExpantableICNon.getData();
