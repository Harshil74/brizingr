...
public class ExpantableMech {
    public static HashMap<String, List<String>> getData() {
        ...
        junkyard.add("Event Description: \n" +
                ...
                "There will be negative marking for false question.\n" +
        ...
        lathe.add("Event Description:-\n" +
                ...
                "\n" +
                "ROUND 2:---\n" +
                "In this round, 10 teams will be selected. Topic will be related to Mechanical Measurements, , Manufacturing Techniques, Manufacturing Processes etc. we will allow you to internet search for 5 minutes only.\n" +
                "\n" +
                "\n" +
                "ROUND 3:---\n" +
        ...
        briztrivia.add("Event Description\n" +
                ...
                "Winning team will be awarded with Exclusive prizes.\n" +
                "\n" +
                "Rules & Regulation:\n" +
                "Any kind of help from Mobile phones are not allowded in event.\n" +
                "\n" +
                "ROUND 1: WRITTEN WAR\n" +
                "\n" +
                "Written war consist of written quiz test of 50 questions covering different topics (For Ex: current affairs, logical reasoning, verbal & Non verbal etc.)\n" +
                "Maximum 1 hour will be provided to all the participants.\n" +
                ...
                "total 11 questions will be asked among all the teams.\n" +
                "Rearrange the given letters to make a meaningful word which will be the answer of your given question.\n" +
                "20 points will be awarded for each correct answer and 10 points will be deducted for each wrong answer.\n" +
                "\n" +
                "ROUND 3: BUZZER ROUND\n" +
                "The type of question in this round can be anything.\n" +
                "Participant who presses the buzzer first will be given the first chance to answer.\n" +
                "20 points will be awarded for each correct answer and 10 points will be deducted for each wrong answer.\n" +
                "\n" +
                "Event flow:\n" +
                "From first round we will choose top 7teams. Which are going to play round 2.\n" +
                "From second round we will choose top 5teams. Which are going to play round 3.\n" +
                "From third round we will choose top 3 teams. Which are going to play the final round.\n" +
                "Winner of final round will be awarded by\n" +
                "exclusive prizes and winning certificate.\n" +
                "Judgement Criteria:\n" +
                "All judgements are taken by event coordinators.");

        List<String> blind = new ArrayList<String>();
        blind.add("Event Description\n" +
                "\n" +
                "Round 1: (Qualifying Round):\n" +
                "One of the participant of the team have to blind fold himself.\n" +
                "They have to perform a task as follows.\n" +
                "Blind folded person have to pick up a ball from the box and then drop that ball into another glass/bowl/box placed away from the pickup box.\n" +
                "Team will be qualified on the count of balls. The team which will transfer more balls in less time is qualified for next round.\n" +
                "\n" +
                "Round 2\n" +
                "Participant have to fill up glass with water from one place and empty that glass in another place.\n" +
